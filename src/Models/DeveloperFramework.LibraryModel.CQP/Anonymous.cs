...
namespace DeveloperFramework.LibraryModel.CQP
{
	...
	/// </summary>
	public class Anonymous : IEquatable<Anonymous>
	{
		#region --属性--
		/// <summary>
		/// 获取当前实例的匿名标识
		...
		public Anonymous (long id, string name, byte[] token)
		{
			Id = id;
		...
		public bool Equals (Anonymous other)
		{
			if (other is null)
			{
				return false;
		...
		{
			return this.Equals (obj as Anonymous);
		}
		/// <summary>
		/// 返回此实例的哈希代码
		/// </summary>
