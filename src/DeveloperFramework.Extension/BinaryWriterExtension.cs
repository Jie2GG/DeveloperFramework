...
namespace DeveloperFramework.Extension
{
	...
	public static class BinaryWriterExtension
	{
		...
		/// <exception cref="ObjectDisposedException">流已关闭。</exception>
		/// <exception cref="ArgumentNullException">buffer 为 null。</exception>
		public static void Write_Ex (this BinaryWriter binary, byte[] value)
		{
			Write_Ex (binary, (short)value.Length);
			SetBinary (binary, value, false);
		}
		/// <summary>
		/// 将基础流转换为相同的字节数组
		/// </summary>
