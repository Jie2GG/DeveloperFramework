...
{   /// <summary>
    ...
    {
        #region --构造函数--
        public SetGroupAnonymousCommand(CQPSimulator simulator, CQPSimulatorApp app, bool isAuth)
        ...
        public override object ExecuteHaveNoAuth()
        {
            ...
            LogCenter.Instance.Info(appInfo.Name, TYPE_CHECK_AUTHORIZATION, $"检测到调用 Api [{nameof(CQPExport.CQ_setGroupAnonymous)}] 未经授权, 请检查 app.json 是否赋予权限", null, null);
