...
namespace DeveloperFramework.Utility
{
    ...
    /// </summary>
    public class HttpUtility : WebClient
    {
        #region --属性--
        /// <summary>
        /// 获取或设置请求的方法
        ...
        #region --构造函数--
        /// <summary>
        /// 初始化 <see cref="HttpUtility"/> 类的一个实例对象
        /// </summary>
        public HttpUtility ()
        {
        ...
        /// </param>
        /// <param name="proxy">代理 <see cref="HttpUtility"/> 的 <see cref="WebProxy"/> 实例</param>
        ...
        {
            HttpUtility httpWebClient = new HttpUtility ();
